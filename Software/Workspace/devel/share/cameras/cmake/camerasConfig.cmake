...
if("TRUE" STREQUAL "TRUE")
  set(cameras_SOURCE_PREFIX /home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/src/cameras)
  set(cameras_DEVEL_PREFIX /home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/devel)
  set(cameras_INSTALL_PREFIX "")
  set(cameras_PREFIX ${cameras_DEVEL_PREFIX})
else()
  set(cameras_SOURCE_PREFIX "")
  set(cameras_DEVEL_PREFIX "")
  set(cameras_INSTALL_PREFIX /home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/install)
...
if(NOT "/home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/devel/include" STREQUAL "")
  set(cameras_INCLUDE_DIRS "")
  set(_include_dirs "/home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'cameras' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/src/cameras/${idir}'.  Ask the maintainer 'sean <sean@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/devel/lib;/home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/devel/lib;/home/sean/catkin_ws/devel/lib;/opt/ros/hydro/lib)
