...
class SteeringCalc:
    ...
    def update_values(self, angle_deg, velocity):
        ...
        # print(self.back_right_angle)
        # print(self.back_left_angle)
        ...
        self.velocity_left = velocity * self.safety_constant * abs((self.radius_left / self.origin_to_centre)) #Leftside (FL, BL)
        self.velocity_right = velocity * self.safety_constant * abs((self.radius_right / self.origin_to_centre)) #Rightside (FR, BR)
