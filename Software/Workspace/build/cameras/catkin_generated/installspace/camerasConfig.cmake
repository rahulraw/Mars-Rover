...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'cameras' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/install/${idir}'.  Ask the maintainer 'sean <sean@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/install/lib;/home/sean/FYDP/uwrobotics.uwmrt/Software/Workspace/devel/lib;/home/sean/catkin_ws/devel/lib;/opt/ros/hydro/lib)
