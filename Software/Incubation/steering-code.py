...
class steering:
	...
	def calc_all(self):
		...
		print "Front right wheel angle: %s" % convert_radians_to_degrees(example1.front_right_angle);	
		print "Back right right wheel angle: %s" % convert_radians_to_degrees(example1.back_right_angle);
		print "Front left wheel angle: %s" % convert_radians_to_degrees(example1.front_left_angle);
		print "back right wheel angle: %s" % convert_radians_to_degrees(example1.back_left_angle);

	
	
		
RCInput = 10;
example1 = steering(RCInput, 0, False);
example1.calc_all();
